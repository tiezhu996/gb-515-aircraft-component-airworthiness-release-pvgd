...
// CreateCertificateRecord is the public write contract for 证书记录. Status is deliberately
// omitted so callers cannot bypass the service state machine.
type CreateCertificateRecord struct {
...
type UpdateCertificateRecord struct {
